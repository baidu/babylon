...
TEST(UsesAllocatorConstructor, constructible_with_raw_args) {
    ...
    ASSERT_FALSE((Constructible<S, ::std::allocator<void>, int, int>::USES_ALLOCATOR));
    s.~S();
...
TEST(UsesAllocatorConstructor, constructible_with_allocator) {
    ...
    ASSERT_TRUE((Constructible<S, ::std::allocator<void>, int, int>::USES_ALLOCATOR));
    ASSERT_TRUE((Constructible<S, ::std::allocator<void>, int, int, int>::value));
    ASSERT_FALSE((Constructible<S, ::std::allocator<void>, int, int, int>::USES_ALLOCATOR));
    s.~S();
    UsesAllocatorConstructor::construct(&s, ::std::allocator<void>(), 2);
    ASSERT_EQ(2, s.v);
    s.~S();
...
TEST(UsesAllocatorConstructor, check_already_has_allocator_in_args) {
    {
        struct S {
            ...
            S(::std::allocator_arg_t, allocator_type,
              ::std::allocator_arg_t, allocator_type) {
                v = 2;
            }
            int v {0};
        } s;
        ...
        ASSERT_TRUE((Constructible<S, ::std::allocator<void>, ::std::allocator_arg_t, ::std::allocator<int>>::value));
        ASSERT_FALSE((Constructible<S, ::std::allocator<void>, ::std::allocator_arg_t, ::std::allocator<int>>::USES_ALLOCATOR));
        s.~S();
        UsesAllocatorConstructor::construct(&s, ::std::allocator<void>());
        ASSERT_EQ(1, s.v);
        s.~S();
        UsesAllocatorConstructor::construct(&s, ::std::allocator<void>(), ::std::allocator_arg, ::std::allocator<int>());
        ASSERT_EQ(1, s.v);
        s.~S();
        UsesAllocatorConstructor::construct(&s, ::std::allocator<void>(),
                ::std::allocator_arg, ::std::allocator<int>(), ::std::allocator_arg, ::std::allocator<int>());
        ASSERT_EQ(2, s.v);
    }
    {
        struct S {
        ...
        ASSERT_TRUE((Constructible<S, ::std::allocator<void>>::value));
        ASSERT_TRUE((Constructible<S, ::std::allocator<void>>::USES_ALLOCATOR));
        ASSERT_TRUE((Constructible<S, ::std::allocator<void>, ::std::allocator<int>>::value));
        ASSERT_FALSE((Constructible<S, ::std::allocator<void>, ::std::allocator<int>>::USES_ALLOCATOR));
        s.~S();
        UsesAllocatorConstructor::construct(&s, ::std::allocator<void>());
        ASSERT_EQ(1, s.v);
        s.~S();
        UsesAllocatorConstructor::construct(&s, ::std::allocator<void>(), ::std::allocator<int>());
        ASSERT_EQ(1, s.v);
        s.~S();
        UsesAllocatorConstructor::construct(&s, ::std::allocator<void>(),
...
TEST(UsesAllocatorConstructor, support_pair_even_cant_pass_uses_allocator_test) {
    struct S {
        typedef ::std::allocator<int> allocator_type;
        S() = default;
        S(allocator_type) {
    ...
    ASSERT_FALSE((::std::uses_allocator<::std::pair<S, int>, ::std::allocator<void>>::value));
    ASSERT_TRUE((Constructible<::std::pair<S, int>, ::std::allocator<void>, int, int>::value));
    ASSERT_TRUE((Constructible<::std::pair<S, int>, ::std::allocator<void>, int, int>::USES_ALLOCATOR));
    ASSERT_TRUE((Constructible<::std::pair<S, int>, ::std::allocator<void>, void*, int>::value));
    ASSERT_FALSE((Constructible<::std::pair<S, int>, ::std::allocator<void>, void*, int>::USES_ALLOCATOR));
    {
        ::std::pair<S, int> p;
        p.~pair();
        ...
        p.~pair();
        UsesAllocatorConstructor::construct(&p, ::std::allocator<void>(), nullptr, 1);
    ...
    }
    {
        ...
        p.~pair();
        UsesAllocatorConstructor::construct(&p, ::std::allocator<void>(), 1, nullptr);
    ...
    }
    {
        ...
        ASSERT_EQ(3, p.second.v);
        p.~pair();
        UsesAllocatorConstructor::construct(&p, ::std::allocator<void>(), nullptr, nullptr);
        ASSERT_EQ(4, p.first.v);
        ASSERT_EQ(4, p.second.v);
    }
}
...
TEST(UsesAllocatorConstructor, support_pair_copy_and_move) {
    ...
    ASSERT_TRUE((Constructible<::std::pair<S, int>, ::std::allocator<void>, ::std::pair<S, int>>::value));
    ASSERT_TRUE((Constructible<::std::pair<S, int>, ::std::allocator<void>, ::std::pair<S, int>>::USES_ALLOCATOR));
    ASSERT_TRUE((Constructible<::std::pair<S, int>, ::std::allocator<void>, const ::std::pair<S, int>&>::value));
    ASSERT_TRUE((Constructible<::std::pair<S, int>, ::std::allocator<void>, const ::std::pair<S, int>&>::USES_ALLOCATOR));
    {
        ::std::pair<S, int> pp;
        ::std::pair<S, int> p;
        p.~pair();
        UsesAllocatorConstructor::construct(&p, ::std::allocator<void>(), ::std::move(pp));
        ASSERT_EQ(3, p.first.v);
        p.~pair();
...
TEST(UsesAllocatorConstructor, support_pair_piecewise_construct) {
    ...
    ASSERT_TRUE((Constructible<::std::pair<S, int>, ::std::allocator<void>, ::std::piecewise_construct_t, ::std::tuple<int>, ::std::tuple<int>>::value));
    ASSERT_FALSE((Constructible<::std::pair<S, int>, ::std::allocator<void>, ::std::piecewise_construct_t, ::std::tuple<int>, ::std::tuple<int>>::USES_ALLOCATOR));
    ASSERT_TRUE((Constructible<::std::pair<S, int>, ::std::allocator<void>, ::std::piecewise_construct_t, ::std::tuple<int, int>, ::std::tuple<int>>::value));
    ASSERT_TRUE((Constructible<::std::pair<S, int>, ::std::allocator<void>, ::std::piecewise_construct_t, ::std::tuple<int, int>, ::std::tuple<int>>::USES_ALLOCATOR));
    {
        ::std::pair<S, int> p;
        p.~pair();
        UsesAllocatorConstructor::construct(&p, ::std::allocator<void>(), ::std::piecewise_construct,
...
TEST(MonotonicAllocator, construct_from_monotonic_memory_resource) {
    {
        ...
        auto* bytes = MonotonicAllocator<void, ExclusiveMonotonicBufferResource>(resource).allocate_bytes(128, 64);
        ::memset(bytes, 0, 128);
    ...
    }
    {
        ...
        auto* bytes = MonotonicAllocator<void, SharedMonotonicBufferResource>(resource).allocate_bytes(128, 64);
        ::memset(bytes, 0, 128);
        ASSERT_EQ(0, reinterpret_cast<uintptr_t>(bytes) % 64);
        bytes = MonotonicAllocator<>(resource).allocate_bytes(128, 64);
        ::memset(bytes, 0, 128);
...
TEST(MonotonicAllocator, allocate_aligned_object) {
    ...
    for (size_t i = 0; i < 64; ++i) {
        typedef MonotonicAllocator<S> A;
        A(resource).allocate_bytes(i, 1);
        auto address = reinterpret_cast<uintptr_t>(A(resource).allocate_object<S>());
        ASSERT_EQ(0, address % 64);
    }
    for (size_t i = 0; i < 64; ++i) {
        typedef MonotonicAllocator<S> A;
...
TEST(SwissAllocator, support_uses_allocator) {
    SwissMemoryResource resource;
    auto* vector = SwissAllocator<>(resource).create_object<::std::vector<size_t, SwissAllocator<size_t>>>(10);
    vector->resize(128);
}
#endif
...
TEST(SwissAllocator, support_protobuf) {
    ...
    auto* mm = SwissAllocator<>(resource).create_object<ArenaExample>(::std::move(*m));
