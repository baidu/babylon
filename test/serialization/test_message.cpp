...
struct TestSubObject {
    ...
    BABYLON_COMPATIBLE(
        (b, 1)(i8, 2)(i16, 3)(i32, 4)(i64, 5)
        (u8, 6)(u16, 7)(u32, 8)(u64, 9)
        (f, 16)(d, 17)(e, 18)(s, 19)(by, 20)
        (m, 21)(pm, 22)
        (rb, 23)(ri8, 24)(ri16, 25)(ri32, 26)(ri64, 27)
        (ru8, 28)(ru16, 29)(ru32, 30)(ru64, 31)
        (rf, 38)(rd, 39)(re, 40)
        (rpb, 44)(rpi8, 45)(rpi16, 46)(rpi32, 47)(rpi64, 48)
        (rpu8, 49)(rpu16, 50)(rpu32, 51)(rpu64, 52)
        (rpf, 59)(rpd, 60)(rpe, 61)
    )
};
