...
TEST_F(SerializeTest, int) {
...

  {
    ...
    ::std::ofstream ofs("output/test/dump_int",
...
TEST_F(SerializeTest, string) {
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_empty_string",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_string",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
}
...
TEST_F(SerializeTest, array) {
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_array",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
}
...
TEST_F(SerializeTest, vector) {
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_empty_vector",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_vector",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
}
...
TEST_F(SerializeTest, list) {
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_empty_list",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_list",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
}
...
struct SetSerializable {
  ...
  ::std::unordered_set<IntSerializable, IntSerializableHash,
                       IntSerializableEqual>
      sss;
...
TEST_F(SerializeTest, set) {
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_empty_set",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_set",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
}
...
struct MapSerializable {
  ...
  ::std::unordered_map<IntSerializable, IntSerializable, IntSerializableHash,
                       IntSerializableEqual>
      mss;
...
TEST_F(SerializeTest, map) {
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_empty_map",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_map",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
}
...
TEST_F(SerializeTest, shared_ptr) {
  ...
  {
    ::std::ifstream ifs("output/test/dump_empty_shared_ptr",
                        ::std::ios_base::in);
    if (ifs) {
      string.assign(::std::istreambuf_iterator<char> {ifs}, {});
      ASSERT_TRUE(Serialization::parse_from_string(string, s));
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_empty_shared_ptr",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }

  {
    ::std::ifstream ifs("output/test/dump_inner_empty_shared_ptr",
                        ::std::ios_base::in);
    if (ifs) {
      string.assign(::std::istreambuf_iterator<char> {ifs}, {});
      ASSERT_TRUE(Serialization::parse_from_string(string, s));
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_inner_empty_shared_ptr",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_shared_ptr",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
}
...
TEST_F(SerializeTest, unique_ptr) {
  ...
  {
    ::std::ifstream ifs("output/test/dump_empty_unique_ptr",
                        ::std::ios_base::in);
    if (ifs) {
      string.assign(::std::istreambuf_iterator<char> {ifs}, {});
      ASSERT_TRUE(Serialization::parse_from_string(string, s));
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_empty_unique_ptr",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }

  {
    ::std::ifstream ifs("output/test/dump_inner_empty_unique_ptr",
                        ::std::ios_base::in);
    if (ifs) {
      string.assign(::std::istreambuf_iterator<char> {ifs}, {});
      ASSERT_TRUE(Serialization::parse_from_string(string, s));
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_inner_empty_unique_ptr",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_unique_ptr",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
}
...
TEST_F(SerializeTest, message) {
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_empty_message",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
  ...
  {
    ASSERT_TRUE(Serialization::serialize_to_string(s, string));
    ::std::ofstream ofs("output/test/dump_message",
                        ::std::ios_base::out | ::std::ios_base::trunc);
    ofs << string;
  }
}
