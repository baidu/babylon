...
Any::Meta Any::TypeDescriptor<T, E>::meta_for_instance {.v =
...
template <typename T, typename E>
__attribute__((init_priority(101)))
Any::Meta Any::TypeDescriptor<T, E>::meta_for_inplace_trivial {.v =
    reinterpret_cast<uint64_t>(
            &TypeDescriptor<typename ::std::decay<T>::type>().descriptor)
...
template <typename T, typename E>
__attribute__((init_priority(101)))
Any::Meta Any::TypeDescriptor<T, E>::meta_for_inplace_non_trivial {.v =
    reinterpret_cast<uint64_t>(
            &TypeDescriptor<typename ::std::decay<T>::type>().descriptor)
...
void Any::TypeDescriptor<T, typename ::std::enable_if<
        !::std::is_copy_constructible<T>::value>::type>::copy_constructor(
            void*, const void*) {
    assert(false && "try copy non-copyable instance by copy an babylon::Any instance");
}
...
inline Any::Any(::std::unique_ptr<T>&& value) noexcept :
    _meta {TypeDescriptor<typename ::std::decay<T>::type>().meta_for_instance},
    _holder {.pointer_value = value.release()} {}

template <typename T, typename ::std::enable_if<sizeof(uint64_t) < sizeof(T), int>::type>
inline Any::Any(T&& value) noexcept :
    _meta {TypeDescriptor<typename ::std::decay<T>::type>().meta_for_instance},
    _holder {.pointer_value = new typename ::std::decay<T>::type(::std::forward<T>(value))} {
}

template <typename T, typename ::std::enable_if<sizeof(T) <= sizeof(uint64_t), int>::type>
inline Any::Any(T&& value) noexcept {
...
template <typename T, typename ::std::enable_if<
    ...
    (::std::is_array<T>::value ||
     ::std::is_function<T>::value), int>::type>
inline void Any::construct_inplace(T&& value) noexcept {
    _holder.const_pointer_value = &value;
