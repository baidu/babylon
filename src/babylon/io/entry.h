...
////////////////////////////////////////////////////////////////////////////////
// EntryBuffer begin
inline void EntryBuffer::set_page_allocator(
    PageAllocator& page_allocator) noexcept {
  _page_allocator = &page_allocator;
}

inline void EntryBuffer::begin() noexcept {
  _entry.size = 0;
  _pages = _entry.pages;
  _pages_end = _entry.pages + Entry::INLINE_PAGE_CAPACITY;
  _sync_point = nullptr;
  setp(nullptr, nullptr);
}

inline Entry& EntryBuffer::end() noexcept {
  sync();
  return _entry;
}
// EntryBuffer end
