...
template <typename T>
class SerializeTraits<T, typename ::std::enable_if<::std::is_base_of<
...
constexpr bool SerializeTraits<
    T, typename ::std::enable_if<::std::is_base_of<
           ::google::protobuf::MessageLite, T>::value>::type>::SERIALIZABLE;
