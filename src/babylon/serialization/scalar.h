...
template <> \
class SerializeTraits<type> : public BasicSerializeTraits<SerializeTraits<type>> { \
public: \
...
// float
template <>
class SerializeTraits<float> : public BasicSerializeTraits<SerializeTraits<float>> {
public:
    static constexpr bool SERIALIZABLE = true;
...
// double
template <>
class SerializeTraits<double> : public BasicSerializeTraits<SerializeTraits<double>> {
public:
    static constexpr bool SERIALIZABLE = true;
...
// enum
template <typename T>
class SerializeTraits<T, typename ::std::enable_if<
...
template <typename T>
constexpr bool SerializeTraits<T, typename ::std::enable_if<
    ::std::is_enum<T>::value>::type>::SERIALIZABLE;
template <typename T>
constexpr typename SerializeTraits<T, typename ::std::enable_if<
    ::std::is_enum<T>::value>::type>::WireType
SerializeTraits<T, typename ::std::enable_if<
    ::std::is_enum<T>::value>::type>::WIRE_TYPE;
template <typename T>
constexpr int SerializeTraits<T, typename ::std::enable_if<
    ::std::is_enum<T>::value>::type>::SERIALIZED_SIZE_COMPLEXITY;
