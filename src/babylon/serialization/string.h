...
class SerializeTraits<::std::basic_string<char, CT, A>> :
        public BasicSerializeTraits<SerializeTraits<
            ::std::basic_string<char, CT, A>>> {
private:
...
template <typename CT, typename A>
constexpr int SerializeTraits<::std::basic_string<char, CT, A>>::SERIALIZED_SIZE_COMPLEXITY;
