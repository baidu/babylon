...
public:
    ...
    public:
        ...
        template <typename IT, typename = typename ::std::enable_if<::std::is_convertible<
...
private:
    ...
    struct StaticMeta {
        ...
        static constexpr uint32_t BLOCK_MASK_BITS = __builtin_popcount(BLOCK_SIZE - 1);
        char zero_size_field[0];
    };
    struct Meta : public ::std::conditional<BLOCK_SIZE == 0,
                         DynamicMeta, StaticMeta>::type {};
    ...
    BlockTable* get_qualified_block_table_slow(BlockTable* block_table, size_t expect_block_num);
    ...
    internal::concurrent_vector::RetireList<BlockTable, BlockTableDeleter> _retire_list;
};
