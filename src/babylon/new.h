...
constexpr ::std::align_val_t CACHELINE_ALIGNMENT = ::std::align_val_t(BABYLON_CACHELINE_SIZE);
...
inline constexpr ABSL_ATTRIBUTE_ALWAYS_INLINE
size_t align_up(size_t unaligned_size, ::std::align_val_t alignment) noexcept {
