...
private:
    ...
    ::std::unordered_map<size_t, std::unordered_set<GraphVertexBuilder*>> _producers_for_data_index;
...
public:
    ...
    GraphDependencyBuilder& operator=(GraphDependencyBuilder&&) noexcept = default;
