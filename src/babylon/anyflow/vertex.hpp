...
template <typename T>
ABSL_ATTRIBUTE_ALWAYS_INLINE inline const T* GraphProcessor::option() noexcept {
  return _vertex->option<T>();
}

template <typename T, typename... Args>
ABSL_ATTRIBUTE_ALWAYS_INLINE inline T* GraphProcessor::create_object(
    Args&&... args) noexcept {
...
template <typename T, typename... Args>
ABSL_ATTRIBUTE_ALWAYS_INLINE inline ::babylon::ReusableAccessor<T>
...
inline GraphVertexClosure::GraphVertexClosure(ClosureContext& closure,
