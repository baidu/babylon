...
void MessageAllocationMetadata::update(const ::google::protobuf::Message& message) noexcept {
    if (!_initialized) {
        initialize(message);
    }
...
void MessageAllocationMetadata::reserve(::google::protobuf::Message& message) const noexcept {
    auto* reflection = message.GetReflection();
...
void MessageAllocationMetadata::FieldAllocationMetadata::update(
    ...
    string_reserved = ::std::max(string_reserved, static_cast<int64_t>(str.capacity()));
}
...
void MessageAllocationMetadata::FieldAllocationMetadata::reserve(
    ...
    } else if (descriptor->cpp_type() == ::google::protobuf::FieldDescriptor::CPPTYPE_STRING
            && string_reserved >= 0) {
...
void MessageAllocationMetadata::initialize(const ::google::protobuf::Message& message) {
    ...
    for (int32_t i = 0; i < descriptor->field_count(); ++i) {
        ...
        if (field->cpp_type() == ::google::protobuf::FieldDescriptor::CPPTYPE_MESSAGE) {
            _fields.emplace_back(field, reflection->GetMessageFactory()->GetPrototype(field->message_type()));
        } else if (field->is_repeated()) {
            _fields.emplace_back(field);
        } else if (field->cpp_type() == ::google::protobuf::FieldDescriptor::CPPTYPE_STRING) {
            _fields.emplace_back(field, &reflection->GetStringReference(*_default_instance, field, nullptr));
        }
    }
...
#define __BABYLON_TMP_CASE(case_enum, type) \
        case ::google::protobuf::FieldDescriptor::case_enum: { \
            size_t capacity = reflection->GetRepeatedField<type>(message, descriptor).Capacity(); \
        ...
        case ::google::protobuf::FieldDescriptor::CPPTYPE_ENUM: {
            size_t capacity = get_repeated_enum_field(message, reflection, descriptor).Capacity();
            if (repeated_reserved < capacity) {
                repeated_reserved = capacity;
            }
            break;
...
#define __BABYLON_TMP_CASE(case_enum, type) \
        case ::google::protobuf::FieldDescriptor::case_enum: { \
            auto& repeated_field = reflection->GetRepeatedPtrField<type>(message, descriptor); \
...
#define __BABYLON_TMP_CASE(case_enum, type) \
        case ::google::protobuf::FieldDescriptor::case_enum: { \
            auto* repeated_field = reflection->MutableRepeatedField<type>(&message, descriptor); \
        ...
        __BABYLON_TMP_CASE(CPPTYPE_BOOL, bool)
        case ::google::protobuf::FieldDescriptor::CPPTYPE_ENUM: {
            auto* repeated_field = mutable_repeated_enum_field(message, reflection, descriptor);
            repeated_field->Reserve(repeated_reserved);
            break;
        }
        case ::google::protobuf::FieldDescriptor::CPPTYPE_STRING: {
            auto* repeated_field = reflection->MutableRepeatedPtrField<::std::string>(&message, descriptor);
            repeated_field->Reserve(repeated_reserved);
        ...
        case ::google::protobuf::FieldDescriptor::CPPTYPE_MESSAGE: {
            auto* repeated_field = reflection->MutableRepeatedPtrField<
