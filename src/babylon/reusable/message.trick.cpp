...
static void* get_raw_field(Message& message, const Reflection* reflection, const FieldDescriptor* descriptor) {
#if GOOGLE_PROTOBUF_VERSION >= 3009000
    return reinterpret_cast<char*>(&message) + reflection->schema_.GetFieldOffset(descriptor);
    ...
    return reinterpret_cast<char*>(&message) +
            static_cast<const GeneratedMessageReflection*>(
                reflection)->offsets_[descriptor->index()];
#endif // GOOGLE_PROTOBUF_VERSION < 3002000
}

#if GOOGLE_PROTOBUF_VERSION >= 3018000
static bool is_inlined(const Reflection* reflection, const FieldDescriptor* descriptor) {
    return reflection->schema_.IsFieldInlined(descriptor);
}

static uint32_t* get_inlined_string_donated_array(Message& message, const Reflection* reflection) {
    return reinterpret_cast<uint32_t*>(
            reinterpret_cast<char*>(&message) + reflection->schema_.InlinedStringDonatedOffset());
}

static uint32_t get_inlined_string_index(const Reflection* reflection, const FieldDescriptor* descriptor) {
    return reflection->schema_.InlinedStringIndex(descriptor);
}
#endif // GOOGLE_PROTOBUF_VERSION < 3018000

static void reserve_arena_string_ptr(
        ::google::protobuf::internal::ArenaStringPtr& ptr,
        bool has_default_value,
        const ::std::string* default_string,
        size_t size, ::google::protobuf::Arena* arena) {
...
void MessageAllocationMetadata::FieldAllocationMetadata::reserve_string_field(
    ...
    if (is_inlined(reflection, descriptor)) {
        ...
        auto mask = ~selector;
#if GOOGLE_PROTOBUF_HAS_DONATED_STRING
        auto string = reinterpret_cast<InlinedStringField*>(ptr)
            ->MutableAccessor(
#else // !GOOGLE_PROTOBUF_HAS_DONATED_STRING
        auto& string = *reinterpret_cast<InlinedStringField*>(ptr)
            ->Mutable(
                    ...
                    mask, nullptr);
#else // GOOGLE_PROTOBUF_VERSION < 3020000
                    ArenaStringPtr::EmptyDefault{}, arena, donated,
...
#endif // GOOGLE_PROTOBUF_VERSION < 3018000
    {
        reserve_arena_string_ptr(
                *reinterpret_cast<ArenaStringPtr*>(ptr),
                descriptor->has_default_value(),
                default_string, string_reserved, arena);
    }
}
...
MessageAllocationMetadata::FieldAllocationMetadata::mutable_repeated_enum_field(
    ...
    return reinterpret_cast<::google::protobuf::RepeatedField<int32_t>*>(
        reflection->MutableRawRepeatedField(&message, descriptor,
...
MessageAllocationMetadata::FieldAllocationMetadata::get_repeated_enum_field(
        ...
        const ::google::protobuf::FieldDescriptor* descriptor) {
    return *reinterpret_cast<::google::protobuf::RepeatedField<int32_t>*>(
        reflection->MutableRawRepeatedField(&const_cast<::google::protobuf::Message&>(message), descriptor,
            ::google::protobuf::FieldDescriptor::CPPTYPE_ENUM, -1, nullptr));
}
