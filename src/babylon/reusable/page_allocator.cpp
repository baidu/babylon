...
CachedPageAllocator::~CachedPageAllocator() noexcept {
    _free_pages.try_pop_n<false, false>([&] (Iterator iter, Iterator end) {
        while (iter != end) {
...
void CachedPageAllocator::allocate(void** pages, size_t num) noexcept {
    ...
    _free_pages.pop_n([&] (Iterator begin, Iterator end) {
...
void CachedPageAllocator::deallocate(void** pages, size_t num) noexcept {
    ...
    _free_pages.push_n([&] (Iterator begin, Iterator end) {
        size_t n = end - begin;
...
ConcurrentSummer::Summary
CachedPageAllocator::cache_hit_summary() const noexcept {
...
typename ConcurrentSummer::Summary
PageHeap::cache_hit_summary() const noexcept {
