...
void* memory_resource::allocate(size_t bytes, size_t alignment) noexcept {
    return do_allocate(bytes, alignment);
}

inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void memory_resource::deallocate(void* ptr, size_t bytes,
...
inline ABSL_ATTRIBUTE_ALWAYS_INLINE
bool operator==(const memory_resource& left,
...
public:
    ...
    MonotonicBufferResource& operator=(
            MonotonicBufferResource&&) noexcept = default;
    MonotonicBufferResource& operator=(
            const MonotonicBufferResource&) = delete;
...
template <size_t alignment>
inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void* MonotonicBufferResource::allocate(size_t bytes) noexcept {
    return do_allocate(bytes, alignment);
}
...
template <typename T>
inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void MonotonicBufferResource::register_destructor(T* ptr) noexcept {
...
inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void MonotonicBufferResource::register_destructor(
        void* ptr, void (*destructor)(void*)) noexcept {
...
template <size_t alignment>
inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void* ExclusiveMonotonicBufferResource::allocate(size_t bytes) noexcept {
    do_align<alignment>();
    return SanitizerHelper::unpoison(
        do_allocate_already_aligned(bytes, alignment),
        bytes);
}

inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void* ExclusiveMonotonicBufferResource::allocate(
...
template <typename T>
inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void ExclusiveMonotonicBufferResource::register_destructor(T* ptr) noexcept {
    if (!::std::is_trivially_destructible<T>::value) {
        register_destructor(ptr, &destruct<T>);
    }
}
...
inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void ExclusiveMonotonicBufferResource::register_destructor(
        void* ptr, void (*destructor)(void*)) noexcept {
...
inline ABSL_ATTRIBUTE_ALWAYS_INLINE
PageAllocator& ExclusiveMonotonicBufferResource::page_allocator() noexcept {
    return *_page_allocator;
}

inline ABSL_ATTRIBUTE_ALWAYS_INLINE
size_t ExclusiveMonotonicBufferResource::space_used() const noexcept {
    return _space_used;
}

inline ABSL_ATTRIBUTE_ALWAYS_INLINE
size_t ExclusiveMonotonicBufferResource::space_allocated() const noexcept {
    return _space_allocated;
}

template <size_t alignment>
inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void ExclusiveMonotonicBufferResource::do_align() noexcept {
...
template <>
inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void ExclusiveMonotonicBufferResource::do_align<1>() noexcept {
}

inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void ExclusiveMonotonicBufferResource::do_align(size_t alignment) noexcept {
    _last_page_allocated = (_last_page_allocated + alignment - 1) &
        static_cast<size_t>(-alignment);
}

inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void* ExclusiveMonotonicBufferResource::do_allocate_already_aligned(
        size_t bytes, size_t alignment) noexcept {
    _space_used += bytes;
...
template <size_t alignment>
inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void* SharedMonotonicBufferResource::allocate(size_t bytes) noexcept {
    return _resources.local().allocate<alignment>(bytes);
}

inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void* SharedMonotonicBufferResource::allocate(size_t bytes,
                                              size_t alignment) noexcept {
...
template <typename T>
inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void SharedMonotonicBufferResource::register_destructor(T* ptr) noexcept {
    register_destructor(ptr, &destruct<T>);
}

inline ABSL_ATTRIBUTE_ALWAYS_INLINE
void SharedMonotonicBufferResource::register_destructor(
        void* ptr, void (*destructor)(void*)) noexcept {
    _resources.local().register_destructor(ptr, destructor);
}

inline ABSL_ATTRIBUTE_ALWAYS_INLINE
SharedMonotonicBufferResource::DestroyTask*
SharedMonotonicBufferResource::get_destroy_task() noexcept {
    return _resources.local().get_destroy_task();
}

inline ABSL_ATTRIBUTE_ALWAYS_INLINE
PageAllocator& SharedMonotonicBufferResource::page_allocator() noexcept {
    return *_page_allocator;
}
