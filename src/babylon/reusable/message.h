...
private:
    ...
    struct FieldAllocationMetadata {
        FieldAllocationMetadata(const ::google::protobuf::FieldDescriptor* descriptor) noexcept;
        FieldAllocationMetadata(const ::google::protobuf::FieldDescriptor* descriptor,
        ...
        // 更新repeated字段
        void update_repeated_field(const ::google::protobuf::Message& message,
                const ::google::protobuf::Reflection* reflection) noexcept;
        // 更新string字段
        ...
        // 调整repeated字段
        void reserve_repeated_field(::google::protobuf::Message& message,
                const ::google::protobuf::Reflection* reflection,
                ::google::protobuf::Arena* arena) const;

        // 特殊trick函数，调整string field底层的ArenaStringPtr或InlinedStringField本体容量
        void reserve_string_field(::google::protobuf::Message& message,
                const ::google::protobuf::Reflection* reflection,
                ::google::protobuf::Arena* arena) const;

        // 特殊trick函数，用于获取可变repeated enum成员
        static ::google::protobuf::RepeatedField<int32_t>* mutable_repeated_enum_field(
            ::google::protobuf::Message& message,
            const ::google::protobuf::Reflection* reflection,
            const ::google::protobuf::FieldDescriptor* descriptor);

        // 特殊trick函数，用于获取只读repeated enum成员
        static const ::google::protobuf::RepeatedField<int32_t>& get_repeated_enum_field(
        ...
        ::std::unique_ptr<MessageAllocationMetadata> message_allocation_metadata {nullptr};
...
template <typename T>
class ReusableTraits<T, typename ::std::enable_if<
...
template <typename T>
constexpr bool ReusableTraits<T, typename ::std::enable_if<
    ::std::is_base_of<::google::protobuf::Message, T>::value>::type>::REUSABLE;
