...
template <typename T, typename A, typename... Args>
constexpr bool UsesAllocatorConstructor::Constructible<T, A, Args...>::USES_ALLOCATOR;
template <typename T, typename A, typename... Args>
...
#if __cplusplus < 201703L
template <typename A, typename... Args>
constexpr bool UsesAllocatorConstructor::Constructible<NeverUsed, A, Args...>::USES_ALLOCATOR;
template <typename A, typename... Args>
constexpr bool UsesAllocatorConstructor::Constructible<NeverUsed, A, Args...>::value;
#endif // __cplusplus < 201703L
...
template <typename U, typename A, typename... Args, typename ::std::enable_if<
    UsesAllocatorConstructor::Constructible<U, A, Args&&...>::PREFIXED, int>::type>
inline void UsesAllocatorConstructor::construct(U* ptr, const A& allocator, Args&&... args) noexcept {
    new (const_cast<void*>(reinterpret_cast<const void*>(ptr))) U(::std::allocator_arg, allocator, ::std::forward<Args>(args)...);
}

template <typename U, typename A, typename... Args, typename ::std::enable_if<
    UsesAllocatorConstructor::Constructible<U, A, Args&&...>::SUFFIXED, int>::type>
inline void UsesAllocatorConstructor::construct(U* ptr, const A& allocator, Args&&... args) noexcept {
    new (const_cast<void*>(reinterpret_cast<const void*>(ptr))) U(::std::forward<Args>(args)..., allocator);
}

template <typename U, typename A, typename... Args, typename ::std::enable_if<
    !UsesAllocatorConstructor::Constructible<U, A, Args...>::USES_ALLOCATOR
    && !UsesAllocatorConstructor::PairConstructible<U, A, Args...>::value, int>::type>
inline void UsesAllocatorConstructor::construct(U* ptr, A, Args&&... args) noexcept {
...
template <typename P, typename A, typename PP, typename ::std::enable_if<
    UsesAllocatorConstructor::PairCopyOrMoveConstructible<P, A, PP>::value, int>::type>
inline void UsesAllocatorConstructor::construct(P* pair, A allocator, PP&& other) noexcept {
...
template <typename P, typename A, typename FF, typename ::std::enable_if<
    !UsesAllocatorConstructor::PairCopyOrMoveConstructible<P, A, FF>::value
    && UsesAllocatorConstructor::PairConstructible<P, A, FF>::value, int>::type>
inline void UsesAllocatorConstructor::construct(P* pair, A allocator, FF&& first) noexcept {
    construct(&pair->first, allocator, ::std::forward<FF>(first));
    construct(&pair->second, allocator);
}

template <typename P, typename A, typename FF, typename SS, typename>
inline void UsesAllocatorConstructor::construct(P* pair, A allocator, FF&& first, SS&& second) noexcept {
    construct(&pair->first, allocator, ::std::forward<FF>(first));
...
inline void UsesAllocatorConstructor::construct(P* pair, A allocator, ::std::piecewise_construct_t,
...
inline void UsesAllocatorConstructor::construct_from_tuple_with_indexes(T* ptr, A allocator,
...
struct UsesAllocatorConstructor::PairConstructible<P, A> {
    ...
    static constexpr bool value = Constructible<F, A>::value
        && Constructible<S, A>::value;
    static constexpr bool USES_ALLOCATOR = value
        && (Constructible<F, A>::USES_ALLOCATOR
...
struct UsesAllocatorConstructor::PairConstructible<P, A, ::std::piecewise_construct_t, ::std::tuple<FArgs...>, ::std::tuple<SArgs...>> {
    using F = typename PairTraits<typename ::std::remove_cv<P>::type>::FirstType;
    using S = typename PairTraits<typename ::std::remove_cv<P>::type>::SecondType;
...
inline T* BasicMonotonicAllocator<T, A>::allocate() noexcept {
...
template <typename T, typename A>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline void BasicMonotonicAllocator<T, A>::deallocate(
    T*, size_type) noexcept {}

template <typename T, typename A>
template <typename U, typename... Args, typename>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline void BasicMonotonicAllocator<T, A>::construct(
        U* ptr, Args&&... args) noexcept {
    UsesAllocatorConstructor::construct(ptr,
                                        rebind_to<U>(),
...
template <typename U>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline void BasicMonotonicAllocator<T, A>::destroy(U* ptr) noexcept {
...
template <typename T, typename A>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline void BasicMonotonicAllocator<T, A>::deallocate_bytes(
    void*, size_t, size_t) noexcept {}

template <typename T, typename A>
template <typename U>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline U* BasicMonotonicAllocator<T, A>::allocate_object() noexcept {
...
template <typename U>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline U* BasicMonotonicAllocator<T, A>::allocate_object(size_t num) noexcept {
...
template <typename U>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline void BasicMonotonicAllocator<T, A>::deallocate_object(
    U*, size_t) noexcept {}

template <typename T, typename A>
template <typename U, typename... Args>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline U* BasicMonotonicAllocator<T, A>::new_object(Args&&... args) noexcept {
...
template <typename U>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline void BasicMonotonicAllocator<T, A>::delete_object(U* ptr) noexcept {
    auto& allocator = static_cast<A&>(*this);
...
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline T* BasicMonotonicAllocator<T, A>::create(Args&&... args) noexcept {
    auto& allocator = static_cast<A&>(*this);
...
template <typename U, typename... Args>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline U* BasicMonotonicAllocator<T, A>::create_object(
        Args&&... args) noexcept {
...
template <typename U>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline typename BasicMonotonicAllocator<T, A>::template rebind<U>::other
BasicMonotonicAllocator<T, A>::rebind_to() noexcept {
    using TA = ::std::allocator_traits<A>;
    return typename TA::template rebind_alloc<U> {
        *static_cast<A*>(this)};
}
...
template <typename U>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline MonotonicAllocator<T, M>::MonotonicAllocator(
    const MonotonicAllocator<U, M>& other) noexcept
        : MonotonicAllocator {other.resource()} {}

template <typename T, typename M>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline MonotonicAllocator<T, M>::MonotonicAllocator(M& resource) noexcept :
    _resource {&resource} {}
...
template <typename T, typename M>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline M* MonotonicAllocator<T, M>::resource() const noexcept {
    return _resource;
}

template <typename T, typename M>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline T* MonotonicAllocator<T, M>::allocate() noexcept {
    return static_cast<T*>(
        _resource->template allocate<alignof(T)>(sizeof(T)));
}

template <typename T, typename M>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline T* MonotonicAllocator<T, M>::allocate(size_t num) noexcept {
    return static_cast<T*>(
...
template <typename T, typename M>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline void* MonotonicAllocator<T, M>::allocate_bytes(size_t nbytes) noexcept {
    return allocate_bytes(nbytes, alignof(::max_align_t));
}

template <typename T, typename M>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline void* MonotonicAllocator<T, M>::allocate_bytes(
...
template <typename U>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline void MonotonicAllocator<T, M>::register_destructor(
        U* ptr) noexcept {
...
template <typename U>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline SwissAllocator<T>::MonotonicAllocator(
...
template <typename T>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline SwissMemoryResource* SwissAllocator<T>::resource() const noexcept {
    return _resource;
}

template <typename T>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline T* SwissAllocator<T>::allocate() noexcept {
    return static_cast<T*>(
        _resource->template allocate<alignof(T)>(sizeof(T)));
}
...
template <typename T>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline T* SwissAllocator<T>::allocate(size_t num) noexcept {
    return static_cast<T*>(
        _resource->template allocate<alignof(T)>(sizeof(T) * num));
}
...
template <typename T>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline void* SwissAllocator<T>::allocate_bytes(size_t nbytes) noexcept {
    return allocate_bytes(nbytes, alignof(::max_align_t));
}

template <typename T>
ABSL_ATTRIBUTE_ALWAYS_INLINE
inline void* SwissAllocator<T>::allocate_bytes(
        size_t nbytes, size_t alignment) noexcept {
    return _resource->allocate(nbytes, alignment);
}
